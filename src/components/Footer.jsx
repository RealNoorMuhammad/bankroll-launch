  ...
  return (
    <footer className="w-full bg-black">
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-6 py-10 md:flex-row md:items-center md:justify-between md:gap-6 md:px-10 md:py-8 lg:px-14">
        <Link to="/" className="shrink-0" aria-label="1-800-BANKROLL home">
          <img
            src={logo}
            alt="1-800-BANKROLL — No help. Just profits."
            className="h-16 w-auto object-contain sm:h-[4.5rem] md:h-20"
            decoding="async"
          />
        </Link>
